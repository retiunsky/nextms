...
const colors = {
  ...
  layout: {
    general: {
      bodyBg: '#33C2FF' // changed from #fff
    },
    sidebar: {
      background: '#fcfbfc',
  ...
  info: {
    lighter: lighten(themeColors.info, 0.85), // try bground
...
export const Aqua = createTheme({
  ...
  palette: {
    ...
    info: {
      ...
      contrastText: colors.alpha.white[90]
    },
    warning: {
