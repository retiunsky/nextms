...
export default function HeaderSearch() {
  ...
  const handleSubmit = (ev) => {
    if (ev.key === 'Enter') {    
    ev.preventDefault();
    router.push(`${NEXT_URL}/products/search?term=${term}`);
    setTerm("");
  }};
  ...
  return (
    <>
      <Tooltip PopperProps={{style:{zIndex:100000}}}  arrow title="Search products">
        <IconButton color="primary" onClick={handleClickOpen}>
          <SearchTwoToneIcon />
        </IconButton>
      </Tooltip>

      <DialogWrapper style={{zIndex:10000}}
        open={open}
      ...
      >
        <DialogTitleWrapper>
          <SearchInputWrapper onKeyDown={handleSubmit}
